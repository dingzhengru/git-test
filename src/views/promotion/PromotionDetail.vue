<template>
  <div class="promotion-detail" :class="{ 'promotion-detail-auth': isLoggedIn }">
    ...
    <div class="promotion-detail__main">
      <div class="promotion-detail__main__content" v-for="content in contentList" :key="content.name">
      ...
      <div class="promotion-detail__main__button">
        <button class="promotion-detail__main__button--back ui-btn ui-btn-long" @click="$router.go(-1)">
