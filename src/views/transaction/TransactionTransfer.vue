...
/* .panel-wallet-range .range-bar {
  background: url(~@/assets/common/imgs/main/sliderBar.png) no-repeat;
}
.panel-wallet-range .range-handle {
  background: url(~@/assets/common/imgs/main/sliderPoint.png) no-repeat;
} */
</style>
